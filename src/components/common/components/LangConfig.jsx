  ...
  en: {
    translation: {
      ...
      aboutPage: {
        ...
        story: "Our Story",
        paragraph1:
          "Launced in 2015, FunCart is South Asia’s premier online shopping makterplace with an active presense in Bangladesh. Supported by wide range of tailored marketing, data and service solutions, FunCart has 10,500 sallers and 300 brands and serves 3 millioons customers across the region.",
        paragraph2:
          "FunCart has more than 1 Million products to offer, growing at a very fast. FunCart offers a diverse assotment in categories ranging from consumer.",
  ...
  gr: {
    translation: {
      ...
      aboutPage: {
        ...
        paragraph1:
          "Gestartet im Jahr 2015, ist FunCart der führende Online-Shopping-Marktplatz Südasiens mit einer aktiven Präsenz in Bangladesch. Unterstützt von einer breiten Palette maßgeschneiderter Marketing-, Daten- und Service-Lösungen hat FunCart 10.500 Verkäufer und 300 Marken und bedient 3 Millionen Kunden in der Region.",
        paragraph2:
          "FunCart hat mehr als 1 Million Produkte im Angebot, die sehr schnell wachsen. FunCart bietet eine vielfältige Auswahl in Kategorien, die von Verbraucher.",
  ...
  ar: {
    translation: {
      ...
      aboutPage: {
        ...
        story: "قصتنا",
        paragraph1:
          "بدأت FunCart في عام 2015، وهي السوق الرائدة للتسوق عبر الإنترنت في جنوب آسيا بوجود نشط في بنغلاديش. مدعومة بمجموعة واسعة من حلول التسويق والبيانات والخدمات المخصصة، يضم FunCart 10،500 بائع و 300 علامة تجارية ويخدم 3 ملايين عميل في المنطقة.",
        paragraph2:
          "يقدم FunCart أكثر من مليون منتج، وهو ينمو بسرعة كبيرة. يقدم FunCart مجموعة متنوعة من الفئات التي تتراوح من المستهلك.",
      ...
      loginPage: {
        title: "تسجيل الدخول إلى FunCart",
        enter: "أدخل بياناتك أدناه:",
  ...
  es: {
    translation: {
      ...
      aboutPage: {
        ...
        paragraph1:
          "FunCart comenzó en 2015, siendo el principal mercado de compras en línea en Asia del Sur con presencia activa en Bangladesh. Respaldado por una amplia gama de soluciones de marketing, datos y servicios personalizados, FunCart cuenta con 10,500 vendedores y 300 marcas, y atiende a 3 millones de clientes en la región.",
        paragraph2:
          "FunCart ofrece más de un millón de productos y está creciendo rápidamente. FunCart ofrece una variedad de categorías que van desde el consumidor.",
      ...
      loginPage: {
        title: "Iniciar sesión en FunCart",
        enter: "Ingrese sus datos a continuación:",
